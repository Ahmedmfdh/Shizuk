            ...
            [
                [
                      InlineKeyboardButton(
                        "◁ الـمـجـمـوعـات ▷", callback_data=f"EE_NI"),
                ],[
                InlineKeyboardButton(
                        "◁ الـبـوت ▷", callback_data=f"M_U_S_I_C_X_bot"),
                ],[
                    InlineKeyboardButton(
                        "♬ ᥉υ᥆ᖇᥴᥱ ƒᥲ️︎ᖇᥲ️︎ωℓᥲ️︎ ♬", callback_data=f"H_A_S_I_S_A"),
                ],[
                    InlineKeyboardButton(
...
#كول باك المطورين
@app.on_callback_query(filters.regex("H_A_S_I_S_A"))
async def ayamr(_, query: CallbackQuery):
   await query.edit_message_caption(caption =f"""[ٓ♡ | 𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝑆𝑂𝐔𝑅𝐶𝐸 .](https://t.me/EE_0B)""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                      InlineKeyboardButton(
                        "♬ ᥉υ᥆ᖇᥴᥱ ƒᥲ️︎ᖇᥲ️︎ωℓᥲ️︎ ♬", url=f"https://t.me/EE_0B"),
                ],[ 
                InlineKeyboardButton(
